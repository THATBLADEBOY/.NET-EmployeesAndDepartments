    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-2BPE20J\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;";
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = @"UPDATE Employee
                                           SET FirstName = @firstName, LastName = @lastName, DepartmentId = @depId
                                         WHERE Id = @id";
